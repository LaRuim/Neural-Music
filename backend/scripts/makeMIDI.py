...
usage: makeMIDI.py [-h] [--smooth SMOOTH]
                                [--minduration MINDURATION] [--jams]
                                infile outfile bpm


Examples:
python makeMIDI.py --smooth 0.25 --minduration 0.1 --jams
...
def makeMIDI(infile, outfile, bpm, smooth=0.25, minduration=0.1,
                          savejams=False):
