...
def preProcessing(fileName):
    midi = getMIDI(fileName)
    time_signatures = getTimeSignature(midi)
    key_tonic_name, key_mode = getScale(midi)
    durations = getDurations(midi)
...
for fileName in glob.glob(PATH):
    try:
        ...
        midi, time_signatures, key_tonic_name, key_mode, durations, chords_list = preProcessing(fileName)
        #print(chords_list)
        ...
        print(f"Song: {fileName} HAS FAILED. :((((((((((((((\n", "*"*30)
        continue
