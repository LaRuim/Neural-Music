...
def create_network(network_input, n_vocab):
    ...
    model.load_weights('./data/weights-improvement.hdf5')
...
def create_midi(prediction_output):
    ...
    midi_stream.write('midi', fp='./converted/{}.mid'.format(filename))

create()
MIDI_to_mp3(filename, 'output')
