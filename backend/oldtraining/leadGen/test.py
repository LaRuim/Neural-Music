...
parser = argparse.ArgumentParser(
    description="Important variables for training model")
    
parser.add_argument('-p', action='store', dest='PATH',
                    help='get path of midi files')
parser.add_argument('-cp', action='store',
                    dest='chord_progression', help='storing chordprogression', type=str)
parser.add_argument('-t', action='store',
                    dest='major_minor', help='storing whether major or minor', type=str)
results = parser.parse_args()
PATH = results.PATH
chord_progression = results.chord_progression
major_minor = results.major_minor
...
def train(model, network_input, network_output):
    ...
    filepath = f"./data/weights/{major_minor}/{chord_progression}/weights.hdf5"
    ...
    model.fit(network_input, network_output, epochs=n_epochs,
