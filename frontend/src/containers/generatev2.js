...
const Generate = (props) => {
	...
	const handleReqSplit = (event, TrackPath = "") => {
	...
	return (
		...
		>
						...
						<div className="text-center">
							...
							<ButtonGroup className="mr-5" size="lg">
								<Button
									onClick={(event) => {
										onNext(5);
										var tracks = store.getState()
											.userTracks;
										var trackPath =
											tracks[tracks.length - 1][0].src;
										handleReqSplit(event, trackPath);
									}}
									variant="primary"
								>
					...
					<Modal.Body>
						...
						<div className="text-center">
							<div className="def-number-input number-input small">
								<Tooltip
									title="Beats Per Minute of your Lead Track"
									placement="left"
								>
								...
								<Tooltip
									title="Only change if you know what you're doing"
									placement="top"
								>
									<div
										style={{
							...
							<div className="def-number-input number-input small">
								<Tooltip
									title="Number of milliseconds a sound must be present for it to be considered a distinct note"
									placement="left"
								>
									<div style={{ display: "inline-block" }}>
										<h5
								...
								<Tooltip
									title="Whether the chords are played as one chord or in a broken style"
									placement="right"
								>
									<div
										style={{
									...
									>
										...
										<select
											className="browser-default custom-select-small"
											onChange={(e) =>
				...
				<>
					<Modal.Body>
						...
						<div className="text-center">
							<div className="def-number-input number-input small">
								<Tooltip
									title="Beats Per Minute the generated Lead Track"
									placement="left"
								>
									<div style={{ display: "inline-block" }}>
										<h5
			...
			{index == 4 && (
				<>
					<Modal.Body>
						{requiredTrackType === "Backing" && (
							<h4 style={{ color: "black" }}>
								Generating Backing Track
							</h4>
						)}
						{requiredTrackType === "Lead" && (
							<h4 style={{ color: "black" }}>
								Generating Lead Track
							</h4>
						)}
						<p style={{ color: "black" }}>
							Please wait while your {requiredTrackType} Track is
							being generated.
						</p>
					</Modal.Body>
					<Modal.Footer>
			...
			{index == 5 && (
				<>
					<Modal.Body>
						<h4 style={{ color: "black" }}>
							Splitting vocals and instrumentals
						</h4>

						<p style={{ color: "black" }}>
							Please wait while your audio Track is being split.
						</p>
					</Modal.Body>
					<Modal.Footer>
						<Button onClick={props.onHide}>Close</Button>
